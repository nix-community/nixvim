...
with nixvimUtils; rec {
  ...
  mkCompositeOption' = {options, ...} @ args:
    mkNullOrOption' (
    ...
    */
    mkDesc = default: desc: let
      ...
      defaultString =
        if isString default
        then default
        else generators.toPretty {} default;
      defaultDesc =
        "Plugin default:"
        + (
    ...
    mkNullable' = {
      ...
      mkNullOrOption' (convertArgs args);
    mkNullable = type: default: description:
      mkNullable' {inherit type default description;};

    mkNullableWithRaw' = {type, ...} @ args: mkNullable' (args // {type = nixvimTypes.maybeRaw type;});
    mkNullableWithRaw = type: default: description:
    ...
    mkStrLuaOr = type: default: description:
    ...
    mkStrLuaFnOr' = {
      ...
      mkNullOrStrLuaFnOr' (convertArgs args);
    mkStrLuaFnOr = type: default: description:
    ...
    mkLuaFn' = {
      ...
      mkNullOrLuaFn' (convertArgs args);
    ...
    mkListOf' = {type, ...} @ args: mkNullable' (args // {type = with nixvimTypes; listOf (maybeRaw type);});
    mkListOf = type: default: description:
      mkListOf' {inherit type default description;};

    mkAttrsOf' = {type, ...} @ args: mkNullable' (args // {type = with nixvimTypes; attrsOf (maybeRaw type);});
    mkAttrsOf = type: default: description:
      ...
      assert default == null || elem default values;
        mkNullableWithRaw' (
          ...
          // {
            ...
            default =
              if isString default
              then generators.toPretty {} default
              else default;
    ...
    mkBorder = default: name: description:
    ...
    mkHighlight' = {description ? "Highlight settings.", ...} @ args:
      mkNullable' (
        args
        // {
    ...
    mkHighlight = default: name: description:
      mkHighlight' (
        {
          inherit default;
        }
  ...
  mkPluginPackageOption = name: default:
    mkOption {
      type = types.package;
      inherit default;
