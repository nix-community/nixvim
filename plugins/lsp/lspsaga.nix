...
in
{
  ...
  options = {
    plugins.lspsaga = helpers.neovim-plugin.extraOptionsOptions // {
      ...
      hover = {
        maxWidth = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.9 ''
          Defines float window width.
        '';

        maxHeight = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.8 ''
      ...
      diagnostic = {
        ...
        maxWidth = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.8 ''
          Diagnostic jump window max width.
        '';

        maxHeight = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.6 ''
          Diagnostic jump window max height.
        '';

        maxShowWidth = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.9 ''
          Show window max width when layout is float.
        '';

        maxShowHeight = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.6 ''
      ...
      finder = {
        maxHeight = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.5 ''
          `max_height` of the finder window (float layout).
        '';

        leftWidth = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.3 ''
          Width of the left finder window (float layout).
        '';

        rightWidth = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.3 ''
      ...
      definition = {
        width = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.6 ''
          Defines float window width.
        '';

        height = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0 1.0) 0.5 ''
          Defines float window height.
        '';
      ...
      rename = {
        ...
        projectMaxWidth = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0
          1.0
        ) 0.5 "Width for the `project_replace` float window.";

        projectMaxHeight = helpers.defaultNullOpts.mkNullableWithRaw (types.numbers.between 0.0
          1.0
