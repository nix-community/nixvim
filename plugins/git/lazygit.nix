...
helpers.vim-plugin.mkVimPlugin config {
  ...
  settingsOptions = {
    floating_window_winblend = helpers.defaultNullOpts.mkNullableWithRaw (types.ints.between 0 100) 0 ''
    ...
    config_file_path = helpers.defaultNullOpts.mkNullableWithRaw (
